...
public class PropertyReader {
    // PropertyReader is simple java singleton design pattern  class
    /*
    ...
    */
    ...
    public String getProperty(String propertyName) {
     ...
     Properties prop = new Properties();
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/resourses/proprtiesfile/config.properties");
